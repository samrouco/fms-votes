    ...
    var AdditionalScoreModel = /*#__PURE__*/function () {
      ...
      _createClass(AdditionalScoreModel, [{
        ...
        value: function getTotal() {
          var result = this.getFlow() + this.getSkills() + this.getScene();

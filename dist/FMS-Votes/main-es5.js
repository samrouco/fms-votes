<<<<<<< Updated upstream:dist/FMS-Votes/main-es5.js
...
>>>>>>> Stashed changes:dist/main-es5.js
                };
    ...
    function () {
      ...
      _createClass(RoundModel, [{
        ...
        value: function getRoundScore() {
          var result = 0;
          this.patrons.forEach(function (x) {
            return result += x.getTotalScore();
          });
          result += this.extraScore.getTotal();
          return result;
        }
